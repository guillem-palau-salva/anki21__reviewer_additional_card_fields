- `increase_repCount` (default "false"): overwrites a built-in function from Anki. This might be danerous in the long run. Only enable this if you otherwise run into errors.
